...
import variants_lib.scripts.NoAutofitInflater;

import java.util.Random;

public class BetterVariantsFleetInflater extends DefaultFleetInflater {
    ...
    BetterVariantsFleetInflater(DefaultFleetInflaterParams params) {
        super(params);
    }

    BetterVariantsFleetInflater(DefaultFleetInflaterParams params, float quality, float averageSmods) {
        super(params);
